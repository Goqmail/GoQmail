...
def get_email_body(msg: email.message.Message) -> tuple:
    ...
    Returns:
        Tuple containing (preferred_body, is_html)
    """
    plain_body = ""
    html_body = ""
    ...
    if msg.is_multipart():
        ...
        for part in msg.walk():
            ...
            if content_type == "text/plain":
                try:
                    ...
                    logger.warning(f"Error processing email plain text part: {e}")
                ...
                try:
                    ...
                    if payload:
                        ...
                        # Don't modify the HTML content, keep it original
                        html_body += decoded_payload
                
                except Exception as e:
                    logger.warning(f"Error processing email HTML part: {e}")
    else:
        ...
        if content_type == "text/plain":
            try:
                ...
                logger.warning(f"Error decoding email plain text body: {e}")
            ...
            try:
                ...
                logger.warning(f"Error decoding email HTML body: {e}")
    
    # Prioritize HTML if available (like Gmail does)
    if html_body.strip():
        # Return the HTML content and flag it as HTML
        return html_body.strip(), True
    else:
        # Return plain text and flag it as not HTML
        return plain_body.strip(), False
    ...
    try:
        ...
        for msg_id in message_ids:
            try:
                ...
                # Get email body and whether it's HTML
                ...
                email_data = {
                    ...
                    "date": date,
                    "body": body,
                    "is_html": is_html  # Add flag to indicate if content is HTML
                }
